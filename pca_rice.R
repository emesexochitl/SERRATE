...
ggplot(data, aes(PC1, PC2, color=group, shape=condition)) + geom_point(size=9) + geom_text(aes(label=name), size =3, vjust=-1.75,colour = "black") + xlab(paste0("PC1: ", percentVar[1], "% variance")) + ylab(paste0("PC2: ", percentVar[1], "% variance")) + ggtitle("PCA plot of rice samples (condition")